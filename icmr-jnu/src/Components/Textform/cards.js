...
function Cards(props) {
  return (
    ...
    <Card style={{ "--clr": "#009688" }}>
        <ImageBox>
          <Image src="Images/national-cancer-institute-LnvCEXQwC-o-unsplash.jpg" alt="Cancer-covid-picture" />
        </ImageBox>
        <Content>
      ...
      <Card style={{ "--clr": "#009688" }}>
        <ImageBox>
          <Image src="Images/corona-vaccine-testing.jpg" alt="Vaccine picture" />
        </ImageBox>
        <Content>
