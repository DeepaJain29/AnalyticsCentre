        ...
        boxShadow: "rgba(50, 50, 93, 0.25) 0px 6px 12px -2px, rgba(0, 0, 0, 0.3) 0px 3px 7px -3px" }}>
          ...
          <nav className={`navbar navbar-expand-lg navbar-${props.mode} bg-${props.mode} mx-auto`}>
            <Link className="navbar-brand">
              <img src="Images/Indian_Council_of_Medical_Research_Logo.svg.png" alt="ICMRlogo" width="140" height="70" className="d-inline-block align-text-top mx-3" style={{ marginLeft: '100px' }} />
              <img src="Images/jnulogo-fotor-bg-remover-2023061912027.png" alt="JNUlogo" width="50" height="70" className="d-inline-block align-text-top" />
